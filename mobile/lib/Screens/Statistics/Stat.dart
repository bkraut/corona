            ...
            children: <Widget>[
              Expanded(
                child: Container(
                  ...
                  child: Column(
                    children: <Widget>[
                      Text('Po dnevih za Slovenijo', textAlign: TextAlign.center, style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
                      Expanded(
              ...
              Expanded(
                child: Container(
                  ...
                  child: Column(
                    children: <Widget>[
                      Text('Po državah', textAlign: TextAlign.center, style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
                      Expanded(
                        child: InfectedPerCountryChart()
                      ),
                    ],
                  )
                )
